...
class ParentWindow(Frame):
    def __init__ (self, master):
        ...
        #following prints to console
        print(self.varFName.get())
        print(self.varLName.get())

        '''
        #paint to tkinter window using tkinter pack
        ...
        #paint label and field to tkinter window using tkinter grid
        ...
        #paint button to tkinter window
